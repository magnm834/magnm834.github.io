...
$('.button').click(function() {
	...
	var obeject_to_use 			= objects[random_object_number];
	...
	if (random_object_number < 7) {
		result = '<div class ="object"><img src="' + obeject_to_use + '"/></div>';
	} else {
		result = '<div class ="object ' + color_to_use + '">' + obeject_to_use + '</div>';
	}
